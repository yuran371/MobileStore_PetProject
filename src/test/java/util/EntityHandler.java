...
public class EntityHandler {
    ...
    public static List<ItemsEntity> getItemsEntities() {
        List<ItemsEntity> entities = List.of(ItemsEntity.builder().brand(APPLE).model("iPhone 14")
                                             ...
                                             ItemsEntity.builder().brand(APPLE)
                                                     ...
                                                     .quantity(99).build(),
                                             ItemsEntity.builder().brand(XIAOMI)
                                             ...
                                             ItemsEntity.builder().brand(XIAOMI)
                                                     ...
                                                     .build(),
                                             ItemsEntity.builder().brand(SAMSUNG)
                                             ...
                                             ItemsEntity.builder().brand(SAMSUNG)
                                                     ...
                                                     .build(),
                                             ItemsEntity.builder().brand(SAMSUNG).model("Galaxy A04")
    ...
    public static List<SellHistoryEntity> getSellHistoryEntities() {
        List<SellHistoryEntity> entities = List.of(SellHistoryEntity.builder()
                                                           .sellDate(OffsetDateTime.now().minus(3L, ChronoUnit.MONTHS))
