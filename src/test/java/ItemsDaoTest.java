...
public class ItemsDaoTest {
	...
	void getAllDao() {
		...
		List<ItemsEntity> actual = List.of(new ItemsEntity(1l, "iPhone 14", "Apple", "128 gb black", 89_990.00, "₽", 83),
	...
	void testingGetByIdDao() {
		...
		Optional<ItemsEntity> actual = Optional.of(new ItemsEntity(1l, "iPhone 14", "Apple", "128 gb black", 89_990.00, "₽", 83));
		assertEquals(expected, actual);
	}
}
